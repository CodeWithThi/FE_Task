...
export type ActionType = 'accept' | 'reject' | 'submit' | 'approve' | 'return' | 'transfer';
      ...
      <AlertDialogContent className="max-w-md">
        ...
        {config.requireReason && (
          <div className="space-y-2 py-2">
            ...
            />
            {config.requireReason && actionType !== 'transfer' && !reason.trim() && (
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction
            ...
            className={config.buttonVariant === 'destructive' ? 'bg-destructive text-destructive-foreground hover:bg-destructive/90' : ''}
            disabled={config.requireReason && actionType !== 'transfer' && !reason.trim()}
          >
            {config.buttonText}
          </AlertDialogAction>
        </AlertDialogFooter>
