...
const mockMainTasks: { id: string; title: string; leader: string; department: string; status: TaskStatus; priority: TaskPriority; progress: number; deadline: string; subtaskCount: number }[] = [
  {
    id: '1',
